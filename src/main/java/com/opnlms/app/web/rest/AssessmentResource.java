                ...
                Mono<Assessment> result = assessmentRepository
                    ...
                    .map(existingAssessment -> {
                        if (assessment.getUserId() != null) {
                            existingAssessment.setUserId(assessment.getUserId());
                        }
                        ...
                        if (assessment.getNumberOfQuestions() != null) {
                            existingAssessment.setNumberOfQuestions(assessment.getNumberOfQuestions());
                        }
