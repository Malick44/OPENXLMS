                ...
                Mono<Instructor> result = instructorRepository
                    ...
                    .map(existingInstructor -> {
                        if (instructor.getCourseId() != null) {
                            existingInstructor.setCourseId(instructor.getCourseId());
                        }
                        ...
                        if (instructor.getInstructorUrl() != null) {
                            existingInstructor.setInstructorUrl(instructor.getInstructorUrl());
                        }
                        if (instructor.getInstructorThumbnail() != null) {
                            existingInstructor.setInstructorThumbnail(instructor.getInstructorThumbnail());
                        }
                        if (instructor.getInstructorRating() != null) {
                            existingInstructor.setInstructorRating(instructor.getInstructorRating());
                        }
                        if (instructor.getInstructorRatingCount() != null) {
                            existingInstructor.setInstructorRatingCount(instructor.getInstructorRatingCount());
                        }
                        if (instructor.getInstructorTotalStudents() != null) {
                            existingInstructor.setInstructorTotalStudents(instructor.getInstructorTotalStudents());
                        }
                        if (instructor.getInstructorTotalReviews() != null) {
                            existingInstructor.setInstructorTotalReviews(instructor.getInstructorTotalReviews());
                        }
