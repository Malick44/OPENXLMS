...
/**
 * REST controller for managing {@link com.opnlms.app.domain.Rating}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RatingResource {
                ...
                Mono<Rating> result = ratingRepository
                    ...
                    .map(existingRating -> {
                        ...
                        if (rating.getCourseId() != null) {
                            existingRating.setCourseId(rating.getCourseId());
                        }
                        if (rating.getInstractorId() != null) {
                            existingRating.setInstractorId(rating.getInstractorId());
                        }
                        ...
                        if (rating.getTimestamp() != null) {
                            existingRating.setTimestamp(rating.getTimestamp());
                        }
    ...
    public Mono<ResponseEntity<Rating>> getRating(@PathVariable String id) {
    ...
    public Mono<ResponseEntity<Void>> deleteRating(@PathVariable String id) {
