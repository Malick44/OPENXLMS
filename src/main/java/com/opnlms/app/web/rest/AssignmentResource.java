                ...
                Mono<Assignment> result = assignmentRepository
                    ...
                    .map(existingAssignment -> {
                        ...
                        if (assignment.getSectionId() != null) {
                            existingAssignment.setSectionId(assignment.getSectionId());
                        }
                        if (assignment.getExamDate() != null) {
                            existingAssignment.setExamDate(assignment.getExamDate());
                        }
                        if (assignment.getNumberOfQuestions() != null) {
                            existingAssignment.setNumberOfQuestions(assignment.getNumberOfQuestions());
                        }
