...
public class CourseRowMapper implements BiFunction<Row, String, Course> {
    ...
    public Course apply(Row row, String prefix) {
        ...
        entity.setInstructorId(converter.fromRow(row, prefix + "_instructor_id", String.class));
        ...
        entity.setSubCategoryId(converter.fromRow(row, prefix + "_sub_category_id", String.class));
        return entity;
    }
}
