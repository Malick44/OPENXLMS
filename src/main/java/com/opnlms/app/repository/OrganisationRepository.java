...
@Repository
public interface OrganisationRepository extends ReactiveCrudRepository<Organisation, String>, OrganisationRepositoryInternal {
    @Override
    ...
    @Override
    Mono<Organisation> findById(String id);
