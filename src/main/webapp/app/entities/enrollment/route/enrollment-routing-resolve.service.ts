...
export class EnrollmentRoutingResolveService implements Resolve<IEnrollment | null> {
  constructor(protected service: EnrollmentService, protected router: Router) {}

  resolve(route: ActivatedRouteSnapshot): Observable<IEnrollment | null | never> {
