      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            instructorUrl: expect.any(Object),
            instructorThumbnail: expect.any(Object),
            instructorRating: expect.any(Object),
            instructorRatingCount: expect.any(Object),
            instructorTotalStudents: expect.any(Object),
            instructorTotalReviews: expect.any(Object),
