...
class QuestionResourceIT {
    ...
    private static final String DEFAULT_QUIZZ_ID = "AAAAAAAAAA";
    private static final String UPDATED_QUIZZ_ID = "BBBBBBBBBB";
    ...
    void createQuestion() throws Exception {
        ...
        assertThat(testQuestion.getQuizzId()).isEqualTo(DEFAULT_QUIZZ_ID);
    }
    ...
    void getAllQuestions() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].quizzId")
            .value(hasItem(DEFAULT_QUIZZ_ID));
    }
    ...
    void putExistingQuestion() throws Exception {
        ...
        assertThat(testQuestion.getQuizzId()).isEqualTo(UPDATED_QUIZZ_ID);
    }
    ...
    void partialUpdateQuestionWithPatch() throws Exception {
        ...
        partialUpdatedQuestion.sectionId(UPDATED_SECTION_ID).courseId(UPDATED_COURSE_ID).text(UPDATED_TEXT).quizzId(UPDATED_QUIZZ_ID);
