...
class OptionResourceIT {
    ...
    void createOption() throws Exception {
        ...
        assertThat(testOption.getQuizzId()).isEqualTo(DEFAULT_QUIZZ_ID);
    }
    ...
    void putExistingOption() throws Exception {
        ...
        assertThat(testOption.getQuizzId()).isEqualTo(UPDATED_QUIZZ_ID);
    }
    ...
    void partialUpdateOptionWithPatch() throws Exception {
        ...
        partialUpdatedOption.questionId(UPDATED_QUESTION_ID).correct(UPDATED_CORRECT).quizzId(UPDATED_QUIZZ_ID);
