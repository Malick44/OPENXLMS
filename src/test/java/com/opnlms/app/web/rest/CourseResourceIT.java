...
class CourseResourceIT {
    ...
    private static final String DEFAULT_SUB_CATEGORY_ID = "AAAAAAAAAA";
    private static final String UPDATED_SUB_CATEGORY_ID = "BBBBBBBBBB";
    ...
    void createCourse() throws Exception {
        ...
        assertThat(testCourse.getInstructorId()).isEqualTo(DEFAULT_INSTRUCTOR_ID);
        ...
        assertThat(testCourse.getSubCategoryId()).isEqualTo(DEFAULT_SUB_CATEGORY_ID);
    }
    ...
    void getAllCourses() {
        ...
        webTestClient
            ...
            .value(hasItem(DEFAULT_SUB_CATEGORY_ID));
    }
    ...
    void getCourse() {
        ...
        webTestClient
            ...
            .jsonPath("$.subCategoryId")
            .value(is(DEFAULT_SUB_CATEGORY_ID));
    }
    ...
    void putExistingCourse() throws Exception {
        ...
        assertThat(testCourse.getInstructorId()).isEqualTo(UPDATED_INSTRUCTOR_ID);
        ...
        assertThat(testCourse.getSubCategoryId()).isEqualTo(UPDATED_SUB_CATEGORY_ID);
    }
