...
class AssignmentResourceIT {
    ...
    void createAssignment() throws Exception {
        ...
        assertThat(testAssignment.getUserId()).isEqualTo(DEFAULT_USER_ID);
        ...
        assertThat(testAssignment.getSectionId()).isEqualTo(DEFAULT_SECTION_ID);
        assertThat(testAssignment.getExamDate()).isEqualTo(DEFAULT_EXAM_DATE);
        assertThat(testAssignment.getNumberOfQuestions()).isEqualTo(DEFAULT_NUMBER_OF_QUESTIONS);
    ...
    void putExistingAssignment() throws Exception {
        ...
        Assignment testAssignment = assignmentList.get(assignmentList.size() - 1);
        assertThat(testAssignment.getUserId()).isEqualTo(UPDATED_USER_ID);
        ...
        assertThat(testAssignment.getSectionId()).isEqualTo(UPDATED_SECTION_ID);
        assertThat(testAssignment.getExamDate()).isEqualTo(UPDATED_EXAM_DATE);
        assertThat(testAssignment.getNumberOfQuestions()).isEqualTo(UPDATED_NUMBER_OF_QUESTIONS);
